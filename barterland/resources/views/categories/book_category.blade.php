...
<link rel="stylesheet" href="{{ asset('css/book_category.css')}}">
<head>
    <title>{{ __('بارترلند -> کتاب ها') }}</title>
</head>
...
<div class="container">
    <div class="flex justify-center mt-4 sm:items-center sm:justify-between bg-white ">
        <div class="nav-text" >
            ...
            <ul>
            <li>
                <a href="http://127.0.0.1:8000/category/books">کتاب ها</a>
           </li>
...
<div class="ui vertical center aligned fluid container pt-3" id="header">
        <h2 class="color-headline" style="padding-right: 22px;">{{ __('کتاب ها') }}</h2>
    </div>
