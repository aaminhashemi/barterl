        ...
        <div class="row">
            ...
            <div class="card" style="width:350px pb-lg-3">
                <img class="card-img-top" src="{{ asset('images/' . $item->photo) }}" style="height: 70%" width="70%"
                    alt="">
                <div class="card-body">
                    <a href="{{ route('myAdvDetails', ['id'=>$item->item_id, 'name'=>$item->adv_name]) }}">
                    ...
                    <p>
                        <a href="/ads/edit/{{ $item->item_id }}" class="p-5" style="float:left">
                            <span>/</span>
                            {{ __('ویرایش') }}
                        </a>
                    </p>
                    <p>
                        <a class="p-5 text-danger" data-toggle="modal" data-target="{{'#exampleModal'.$item->item_id}}"
            ...
            <!-- Modal -->
            <div class="modal fade" id="{{'exampleModal'.$item->item_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModal" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a type="button" href="{{route('deleteAdv', $item->item_id)}}"
