...
<div class="item-form clearfix">
    <div class="card-body">
        <form method="POST"
            action="{{ route('updateAdv', $item->id) }}"
        ...
        {{ csrf_field() }}
            ...
            <div class="row">
                ...
                <div class="col-md-12 toto">
                    <input id="adv_name" name="adv_name" type="text" class="form-control @error('adv_name') is-invalid @enderror" placeholder="{{ $item->name }}" value="{{ old('adv_name') }}" autocomplete="adv_name">
                    @error('adv_name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row">
                ...
                <div class="col-md-12 toto">
                    <textarea id="description" name="description" type="text" rows="3" class="form-control @error('description') is-invalid @enderror" placeholder="{{ $item->description }}"></textarea>
                    @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row">
                ...
                <div class="col-md-12 toto">
                    <textarea id="exchangedesc" name="exchangedesc" type="text" rows="3" class="form-control @error('exchangedesc') is-invalid @enderror" placeholder="{{ $item->exchangedesc }}"></textarea>
                    @error('exchangedesc')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row">
                ...
                <div class="col-md-12 toto">
                    <input id="contactway" name="contactway" type="text" class="form-control @error('contactway') is-invalid @enderror" placeholder="{{ $item->contactway }}" value="{{ old('contactway') }}" autocomplete="contactway">
                    @error('contactway')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row">
                ...
                <div class="col-md-12 toto">
                    <select id="city" name="city" class="form-control form-select placeholder @error('city') is-invalid @enderror">
                        <option value="" disabled selected hidden>{{ __('شهرها') }}</option>
