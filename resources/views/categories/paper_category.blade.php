...
<link rel="stylesheet" href="{{ asset('css/paper_category.css')}}">
<head>
    <title>{{ __('بارترلند ->جزوه ها') }}</title>
</head>
<!-- nav -->
<div class="container">
    <div class="flex justify-center mt-4 sm:items-center sm:justify-between bg-white ">
        <div class="nav-text" >
            ...
            <ul>
            <li>
                <a href="http://127.0.0.1:8000/category/papers">جزوه ها</a>
            </li>
...
<div class="ui vertical center aligned fluid container pt-3" id="header">
        <h2 class="color-headline" style="padding-right: 22px;">{{ __('جزوه ها') }}</h2>
    </div>
